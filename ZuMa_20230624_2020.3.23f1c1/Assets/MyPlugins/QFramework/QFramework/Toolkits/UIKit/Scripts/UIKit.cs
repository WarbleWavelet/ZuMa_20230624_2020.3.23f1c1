...
namespace QFramework
{
    ...
    public class UIKit
    {
        ...
        /// <summary> UIPanel  管理（数据结构） </summary>
        public static UIPanelTable Table { get; } = new UIPanelTable();



        #region OpenPanel、ClosePanel、CloseAllPanel
...
")]
#endif
        public static T OpenPanel<T>(PanelOpenType panelOpenType
...
")]
#endif
        public static IEnumerator OpenPanelAsync<T>(UILevel canvasLevel = UILevel.Common
            , IUIData uiData = null
            , string assetBundleName = null
            , string prefabName = null) where T : UIPanel
        {
        ...
        public static T OpenPanel<T>(UILevel canvasLevel = UILevel.Common
            , IUIData uiData = null
            , string assetBundleName = null
            , string prefabName = null) where T : UIPanel
        {
        ...
        public static T OpenPanel<T>(IUIData uiData
...
")]
        ...
        #region ShowPanel、HidePanel、HideAllPanel
