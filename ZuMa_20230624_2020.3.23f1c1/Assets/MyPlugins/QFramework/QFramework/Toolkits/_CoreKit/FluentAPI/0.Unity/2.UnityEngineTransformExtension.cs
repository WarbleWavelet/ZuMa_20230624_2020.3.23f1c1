...
")]
#endif
        public static T DestroyChildren<T>(this T p_Component) where T : Component
        {
            var childCount = p_Component.transform.childCount;

            for (var i = 0; i < childCount; i++)
            {
                p_Component.transform.GetChild(i).DestroyGameObjGracefully();
            }
